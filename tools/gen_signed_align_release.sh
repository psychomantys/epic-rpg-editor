...
$jarsigner -sigalg MD5withRSA -digestalg SHA1 -keystore ~/.android/release.keystore -signedjar release-signed-unalign.apk  "${unsigned_unalign_release_apk}" androidreleasekey
